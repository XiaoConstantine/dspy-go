...
func TestIsValidOpenAIModel(t *testing.T) {
	tests := []struct {
		...
		{core.ModelOpenAIGPT54, true},
		{core.ModelOpenAIGPT54Mini, true},
		{core.ModelOpenAIGPT54Nano, true},
		{core.ModelOpenAIGPT54Pro, true},
		{core.ModelOpenAIGPT55, true},
		{core.ModelOpenAIGPT55Pro, true},
		{"invalid-model", false},
